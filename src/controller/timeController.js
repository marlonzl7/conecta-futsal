...
async function cadastrar(req, res) {
    try {
        const { nome, descricao, idTecnico, cep, logradouro, numero, complemento, bairro, cidade, uf } = req.body;

        const resultado = await timeModel.cadastrar(nome, descricao, idTecnico, cep, logradouro, numero, complemento, bairro, cidade, uf);
